                    ...
                    items: [
                        {
                            ...
                            store: [
                                ...
                                ['modern', 'vCenter-inspired native (recommended)'],
                            ],
                        },
                        {
                            xtype: 'component',
                            cls: 'pmx-inventory-help pmx-typography-help',
                            html: 'Uses Avenir Next on macOS with native Helvetica and Segoe fallbacks. Icons and console text keep their purpose-built fonts.',
                        },
                        {
                            name: 'uiTextSize',
                        ...
                        },
                        {
                            ...
                            html: 'Scales content and navigation text. Compact action bars stay stable so larger text does not overlap.',
                        },
                    ],
                },
                {
    ...
    function installNavigationStyles() {
        ...
        Ext.util.CSS.createStyleSheet(
            scopeThemeStyles([
                ...
                'html body td[class*="itype-icon"] > .x-grid-cell-inner::before { align-self: center !important; flex: 0 0 14px !important; inset: auto !important; margin-top: 0 !important; position: static !important; transform: none !important; vertical-align: initial !important; }',
                ...
                'html body .x-grid:not(.x-tree-panel) .x-grid-item-selected, html body .x-grid:not(.x-tree-panel) .x-grid-item-selected .x-grid-cell, html body .x-grid:not(.x-tree-panel) .x-grid-item-selected .x-grid-td { background-color: var(--proxmorph-modern-selected) !important; border-radius: 0 !important; box-shadow: none !important; }',
                'html body .x-grid:not(.x-tree-panel) .x-grid-item-selected .x-grid-cell-inner, html body .x-grid:not(.x-tree-panel) .x-grid-item-selected .x-grid-cell-inner::before { border: 0 !important; border-radius: 0 !important; box-shadow: none !important; }',
                ...
                'html body .x-tab-default-top.x-tab-active { background-color: var(--proxmorph-modern-selected) !important; border-color: transparent !important; border-radius: var(--proxmorph-control-radius) !important; box-shadow: none !important; }',
                'html body .x-tab-default-top.x-tab-active::after { border: 0 !important; box-shadow: none !important; content: none !important; display: none !important; }',
